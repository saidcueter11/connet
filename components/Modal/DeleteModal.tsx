      ...
      <Modal show={showModal}>
          <Modal.Body className='bg-dark-green rounded-lg'>
            ...
            <div className="flex justify-center gap-4 items-baseline">
              <button className='bg-light-green text-dark-green font-concert-one rounded-lg w-2/5 py-1' onClick={deleteMethod}>Yes, I am sure</button>
              <button className='bg-light-green text-dark-green font-concert-one rounded-lg w-2/5 py-1' onClick={() => setShowModal(false)}>No, cancel</button>
            </div>
          </div>
          </Modal.Body>
        </Modal>
