  ...
  return (
    <header className='relative mb-5 md:hidden'>
      <div className='flex gap-5 flex-col w-4/5 items-center m-auto'>
        ...
        <input className='rounded-3xl max-w-sm w-full shadow px-3 py-1 font-karla outline-dark-green text-center' placeholder="Search posts" value={search} onChange={(e) => setSearch(e.target.value)}/>
      </div>
    </header>
  )
}
